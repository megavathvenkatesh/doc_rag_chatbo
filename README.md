Doc-RAG Chatbot Welcome to the Doc-RAG Chatbot! We can input our pdfs, have multiple chat with the same. hope you like it :)
...
![image](https://github.com/user-attachments/assets/f8b3818c-1f68-4690-b724-89d4d42ccdbc)

we can retrieve the chat history using the threadid as well

![image](https://github.com/user-attachments/assets/3be7c442-722b-47ca-9167-159acadf7758)
